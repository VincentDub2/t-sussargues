...
export function InterventionChatLauncher({
  ...
  const chatPanel = open ? (
    <div className="fixed inset-x-3 bottom-3 top-3 z-50 flex justify-end sm:inset-x-5 sm:bottom-5 sm:top-5">
      <section className="flex h-full w-full max-w-3xl flex-col overflow-hidden rounded-lg border border-border bg-card shadow-2xl xl:max-w-4xl">
        <header className="flex items-center justify-between border-b border-border bg-primary px-5 py-4 text-primary-foreground">
          <div className="flex min-w-0 items-center gap-3">
            ...
            <div className="min-w-0">
              <h2 className="truncate text-base font-bold">Assistant intervention</h2>
              <p className="text-xs text-primary-foreground/80">Sussargues</p>
            </div>
          </div>
          <button
            type="button"
        ...
        <div className="flex-1 space-y-4 overflow-y-auto bg-background p-4 sm:p-6">
